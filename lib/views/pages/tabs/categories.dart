...
class CategoriesGrid extends StatelessWidget {
  ...
  final List<Map<String, String>> categories = [
    ...
    {"title": "Electronics & Gadgets", "icon": "assets/images/electronics.png"},
    {"title": "Home & Kitchen", "icon": "assets/images/house_1.png"},
    {"title": "Health & Beauty", "icon": "assets/images/shampoo.png"},
    {"title": "Sports & Outdoors", "icon": "assets/images/sports.png"},
    {"title": "Jobs", "icon": "assets/images/job.png"},
    {"title": "Services", "icon": "assets/images/customer-service.png"},
    {"title": "Toys & Games", "icon": "assets/images/toys.png"},
    {"title": "Animals & Pets", "icon": "assets/images/pets.png"},
    {"title": "Food and drinks", "icon": "assets/images/diet.png"},
    {"title": "Books & Stationery", "icon": "assets/images/tools.png"},

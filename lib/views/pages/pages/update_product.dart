...
class _UpdateProductState extends ConsumerState<UpdateProduct> {
  ...
  loadProduct() async{
    if(mounted) showDialog(context: context, builder: (context) => const LoadingDialog(msg: "Looking for product...",));
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                onlineImages != null && onlineImages!.isNotEmpty ? Row(
                ...
                Visibility(
                    visible: (imageFiles != null && imageFiles!.isNotEmpty) || (onlineImages != null && onlineImages!.isNotEmpty),
                    maintainSize: false,

                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(color: Colors.red.withAlpha(45), borderRadius: BorderRadius.circular(2)),
                        child: ConstantWidgets.text(context, "25% off"),
                        ),
                    const SizedBox(
                      height: 4,
                    ),
                    Row(
                      children: [
                        Container(
                            ...
                            child: ConstantWidgets.text(context, "available", ),
                            ),
                    ...
                    Expanded(child: Align(alignment: Alignment.bottomLeft, child: ConstantWidgets.text(context, "5 hours ago", color: CartifyColors.battleshipGrey, fontSize: 10))),
                  ],
                ),
              ),
            ),

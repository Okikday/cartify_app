...
class ProductCard2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomBox(
        ...
        constraints: BoxConstraints(maxHeight: 400, maxWidth: screenWidth * 0.4, minHeight: 250),
                  ...
                  Container(
                    ...
                    child: CachedNetworkImage(
                      ...
                      errorWidget: (context, url, error) =>
                          Center(child: SizedBox(width: screenWidth * 0.35, height: 160, child: const Center(child: Icon(Icons.error)))),
                    ),
                  ),
                  Positioned(
                    right: 4,
                      ...
                      children: [
                        ...
                        Visibility(
                          ...
                          child: Container(
                            ...
                            child: BackdropFilter(
                                filter: ImageFilter.blur(sigmaX: 4, sigmaY: 4),
                                child: ConstantWidgets.text(context, "${discountPercentage.truncate()}% off", color: Colors.white)),
                          ),
                        ),
                      ],
                    ),
